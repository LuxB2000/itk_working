...
AffineMultiRegistration<TMovingImage,TFixedImage,Dimension>::Update(){
  ...
  registration->SetNumberOfLevels( m_nbrOfLevels );
	...
	initParam[0] = 1.0; // R(0,0)
	initParam[4] = 1.0; // R(1,1)
	initParam[8] = 1.0; // R(2,2)

	// init translation
	initParam[9] = m_initTranslationX;
	initParam[10] = m_initTranslationY;
	initParam[11] = m_initTranslationZ;
